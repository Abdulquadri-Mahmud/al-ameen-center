  ...
  return (
    <div>
      <Box pt={7} px={{md: 10, base: 5}}>
            <Heading fontSize={25} fontWeight={500}>Who is this for (Admission Requirements)</Heading>
            <Text pt={3} fontSize={{md: 16, base: 16}} fontWeight={500}>
                For parents who wants their kids to have best of both worlds.
            </Text>
            <UnorderedList pt={3} fontWeight={500} fontSize={{md: 16, base: 16}}>
