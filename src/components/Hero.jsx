...
export default function Hero() {
  ...
  return (
    <Box h={{md:'100vh', base: '100vh'}} w={'full'}>
        <Slider {...settings}>
            <Box position={'relative'} backgroundPosition="bottom" backgroundRepeat="no-repeat" backgroundSize="cover" backgroundImage={`url(${hero1})`} h={{md:'100vh', base: '100vh'}} w={'full'}>
                ...
                <Flex justifyContent={'start'} alignItems={'center'} h={'full'} padding={{base: 5, md:10}} zIndex={20} >
                    <Stack flexDirection={'column'} w={{base:'full',md: '100%', xl: '80%'}}>
            ...
            <Box position={'relative'} backgroundPosition="bottom" backgroundRepeat="no-repeat" backgroundSize="cover" backgroundImage={`url(${hero5})`} h={{md:'100vh', base: '100vh'}} w={'full'}>
                <Box position="absolute" top={0} left={0} w="full" h="full" bg="#0f0f0f" opacity={0.5} bgBlendMode="multiply"/>
                <Flex justifyContent={'start'} alignItems={'center'} h={'full'} padding={{base: 5, md:10}} zIndex={20} >
                    <Stack flexDirection={'column'} w={{base:'full',md: '100%', xl: '80%'}}>
                        <Heading color={'white'} zIndex={20} fontWeight={500} textAlign={{md: 'start', base: 'start'}} fontSize={{ base: '4xl', md: '4xl', lg: '5xl' }} lineHeight={1.5} >Welcome <br /> To Al-Ameen Center</Heading>
            ...
            <Box position={'relative'} backgroundPosition="bottom" backgroundRepeat="no-repeat" backgroundSize="cover" backgroundImage={`url(${hero2})`} h={{md:'100vh', base: '100vh'}} w={'full'}>
                <Box position="absolute" top={0} left={0} w="full" h="full" bg="#0f0f0f" opacity={0.5} bgBlendMode="multiply"/>
                <Flex justifyContent={'start'} alignItems={'center'} h={'full'} padding={{base: 5, md:10}} zIndex={20} >
                    <Stack flexDirection={'column'} w={{base:'full',md: '100%', xl: '80%'}}>
                        <Heading color={'white'} zIndex={20} fontWeight={500} textAlign={{md: 'start', base: 'start'}} fontSize={{ base: '4xl', md: '4xl', lg: '5xl' }} lineHeight={1.5} >Welcome <br /> To Al-Ameen Center</Heading>
            ...
            <Box position={'relative'} backgroundPosition="bottom" backgroundRepeat="no-repeat" backgroundSize="cover" backgroundImage={`url(${hero3})`} h={{md:'100vh', base: '100vh'}} w={'full'}>
                <Box position="absolute" top={0} left={0} w="full" h="full" bg="#0f0f0f" opacity={0.5} bgBlendMode="multiply"/>
                <Flex justifyContent={'start'} alignItems={'center'} h={'full'} padding={{base: 5, md:10}} zIndex={20} >
                    <Stack flexDirection={'column'} w={{base:'full',md: '100%', xl: '80%'}}>
                        <Heading color={'white'} zIndex={20} fontWeight={500} textAlign={{md: 'start', base: 'start'}} fontSize={{ base: '4xl', md: '4xl', lg: '5xl' }} lineHeight={1.5} >Welcome <br /> To Al-Ameen Center</Heading>
            ...
            <Box position={'relative'} backgroundPosition="bottom" backgroundRepeat="no-repeat" backgroundSize="cover" backgroundImage={`url(${hero4})`} h={{md:'100vh', base: '100vh'}} w={'full'}>
                <Box position="absolute" top={0} left={0} w="full" h="full" bg="#0f0f0f" opacity={0.5} bgBlendMode="multiply"/>
                <Flex justifyContent={'start'} alignItems={'center'} h={'full'} padding={{base: 5, md:10}} zIndex={20} >
                    <Stack flexDirection={'column'} w={{base:'full',md: '100%', xl: '80%'}}>
                        <Heading color={'white'} zIndex={20} fontWeight={500} textAlign={{md: 'start', base: 'start'}} fontSize={{ base: '4xl', md: '4xl', lg: '5xl' }} lineHeight={1.5} >Welcome <br /> To Al-Ameen Center</Heading>
