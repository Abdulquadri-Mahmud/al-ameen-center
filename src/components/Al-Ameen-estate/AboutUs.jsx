        ...
        <Box w={'full'} bg={useColorModeValue('', 'gray.800')} px={{md:10, base: 3}} py={{md:10, base: 10}}>
            <Flex alignItems={'center'} justifyContent={'space-around'} flexWrap={'wrap'}>
              ...
              <Box w={{md:'45%', base: '100%'}} mt={{base: 7, md: 0}}>
                ...
                <Text pt={3} fontWeight={500} lineHeight={2} textAlign={{md:'start', base: 'start'}}>
                ...
                <Link to={'/about-al-ameen-estate'} className='text-left font-semibold text-1xl underline text-red-600'>See More</Link>
              </Box>
            </Flex>
        </Box>
    </Box>
